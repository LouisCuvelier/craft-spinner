...
namespace louiscuvelier\spinner\fields;

use louiscuvelier\spinner\Spinner;
use louiscuvelier\spinner\assetbundles\spintextfield\SpinTextFieldAsset;
...
class SpinText extends Field
{
    ...
    {
        return Craft::t('spinner', 'Spin Text');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'spinner/_components/fields/SpinText_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(SpinTextFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').SpinnerSpinText(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'spinner/_components/fields/SpinText_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
